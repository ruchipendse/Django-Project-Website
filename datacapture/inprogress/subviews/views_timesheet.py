...
#-------------------------------------
        ...
        # allActivePartsForSetup = (
        #     Part.objects.select_related()
        #     .filter(is_active=True)
        #     .filter(setups__id_code__in = setupIdCodes)
        # )

        # partsForUser = {}
        # for partForSetup in allActivePartsForSetup:
        #     setups = {}
        #     for setupForPart in partForSetup.setups.values():
        #         setup = {
        #             'id_code'       : setupForPart['id_code'],
        #             'name'          : setupForPart['name']
        #         }
        #         setups[setupForPart['id_code']] = setup
        #     part = {
        #         'id_code'           : partForSetup.id_code,
        #         'name'              : partForSetup.name,
        #         'setups'            : setups
        #     }
        #     partsForUser[partForSetup.id_code] = part
...
# def processRequest_OLD(request, function_mode=None, entry_id=-1, landing=None):
#     #TODO: CHECK POSSIBILITY OF HANDLING ONLY POST REQUEST
#     currentDate = datetime.today()
#     if function_mode is None:
#         function_mode = request.POST["functionMode"]
...
#         #TODO: DEFECT: SELECT SETUPS FOR PART WHICH ARE APPLICABLE TO CURRENT USER ONLY
...
#         partsForUserJSON                            = json.dumps(partsForUser)
#         machinesForSetupJSON                        = json.dumps(machinesForSetup)
#         allTimeSheetEntries                         = allTimeSheetEntriesForUserDate(request.user.id, currentDate)
#         allTimeSheetEntriesJSON                     = json.dumps(allTimeSheetEntries)
#         return render(
...
#             "timesheet/newTimeEntry.html",
#             {
#                 "partsForUserJSON": partsForUserJSON,
#                 "machinesForSetupJSON": machinesForSetupJSON,
#                 "currentDate": currentDate,
#                 "allTimeSheetEntriesJSON": allTimeSheetEntriesJSON
#             },
...
#UNUSED
# def relativeTimeDuration(startTime1, endTime1, startTime2, endTime2):
#     #TODO: DEVELOP OVERLAP IDENTIFICATION FUNCTION
#     # INPUT DURATIONS ARE EXECTED IN SORTED ORDER LIKE START-END
#     # THIS WILL RETURN THE RELATION OF TIME DELTAS
#     # DETACHED/ OVERLAPPING/ ATTACHED
#     outerDelta = endTime2 - startTime1
#     innerDelta = endTime1 - startTime2
#     state = outerDelta.seconds * innerDelta.seconds
#     if state < 0:
#         return "DETACHED"
#     elif state > 0:
#         return "OVERLAPED"
